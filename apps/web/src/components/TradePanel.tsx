...
// Approximate liquidation price (simplified: margin / (size * entryPrice) * entryPrice with maintenance margin of 5%)
...
export function TradePanel({ address }: Props) {
  ...
  const entryPrice = MARKET_PRICES[market] ?? 0;
  ...
  return (
    <div className="bg-dark-800 border border-dark-700 rounded-xl overflow-hidden">
      ...
      <div className="p-5 space-y-4">
        ...
        <a
          href={`${process.env.NEXT_PUBLIC_BOT_URL || 'https://t.me/RiseChain_RISEx_Bot'}?start=trade`}
          target="_blank"
