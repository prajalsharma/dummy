...
export const RISECHAIN_RPC_URL = process.env.RISECHAIN_RPC_URL || 'https://testnet.risechain.com';
export const RISEX_API_BASE = process.env.RISEX_API_BASE || 'https://api.testnet.rise.trade';
export const RISEX_WS_URL = process.env.RISEX_WS_URL || 'wss://ws.testnet.rise.trade';
